...
const healthResponses: Record<string, Array<{ keywords: string[], response: string }>> = {
  ...
  hi: [
    ...
    },
    {
      ...
      response: "पीसीओएस (पॉलीसिस्टिक ओवरी सिंड्रोम) एक हार्मोनल विकार है जिससे अंडाशय में छोटी सिस्ट के साथ वृद्धि होती है। लक्षणों में अनियमित मासिक धर्म, अतिरिक्त बाल विकास, और मुँहासे शामिल हैं। उपचार विकल्प उपलब्ल हैं - कृपया विशिष्ट सलाह के लिए अपने डॉक्टर से परामर्श करें।"
    },
    {
