    ...
    <section className="py-12 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-12 font-heading">
          {t('home.medicalExperts.title', 'Our Medical Experts')}
        </h2>
          ...
          {isLoading ? (
            ...
            <div className="col-span-4 text-center p-4">
              <p className="text-red-500">
                {t('home.medicalExperts.failedToLoad', 'Failed to load doctors')}
              </p>
            </div>
          ) : (
              ...
              <Card key={doctor.id} className="bg-white rounded-xl shadow-sm overflow-hidden border border-neutral-100">
                ...
                <CardContent className="p-5">
                  ...
                  <Link to="/doctors" onClick={() => window.scrollTo(0, 0)}>
                    <Button>
                      {t('home.medicalExperts.bookAppointment', 'Book Appointment')}
                    </Button>
                  </Link>
                </CardContent>
              </Card>
        ...
        <div className="text-center mb-12">
          <Link to="/doctors" onClick={() => window.scrollTo(0, 0)}>
            <Button>
              {t('home.medicalExperts.viewAllDoctors', 'View All Doctors')}
            </Button>
          </Link>
        </div>
      </div>
